...
object EarnWorkFlow {
    class Initiator(val tokenState: EarnTokenState,
         ...
         */
        @Suspendable
        override fun call(): EarnFlowResult {
 ...
 */
sealed class EarnFlowResult {
    class Success(val message: String?): EarnFlowResult() {
        override fun toString(): String = "Success($message)"
    }

    class Failure(val message: String?): EarnFlowResult() {
